...
- Check status of your node.
   - Method 1. Key in node's ip address at http://nstatus.org/ and check. Message of request ID generation fee will prompt after all installation are completely done.
    `No ID in this account, waiting for generate ID fee or generate ID transaction. Please verify you have made the node generation payment for node wallet address: NKNZ5v...................` 
